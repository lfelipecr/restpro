...
class ApiModel
{
    ...
    public function getCabecera($cod_ven)
    {
        ...
        {      
            ...
            $stm = $this->db->prepare("SELECT
            tm_venta.enviado_sunat,
            IF(LENGTH(tm_cliente.dni) = 8 ,'1','6') AS tipo_documento,
            IF(LENGTH(tm_cliente.dni) = 8,tm_cliente.dni,tm_cliente.ruc) AS numero_documento,
            IF(LENGTH(tm_cliente.dni) = 8,CONCAT(tm_cliente.nombres),tm_cliente.razon_social) AS razon_social,
            tm_cliente.direccion AS direccion,
            DATE(tm_venta.fecha_venta) AS fecha,
            (tm_venta.fecha_venta) AS fecha_imp,
            IF(tm_venta.id_tipo_doc='1','03','01') AS tipo_comprobante,
