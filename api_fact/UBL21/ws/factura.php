...
$resp = $procesarcomprobante->procesar_factura($array_cabecera, $array_detalle, $rutas,$data['ose']);
...
function get_array_cabecera($data, $emisor) {
    $cabecera = array(
        ...
        'AMAZONAS' =>$emisor['amazonas'],
        'CERT_PSE' => $emisor['certpse']
    );   
...
function get_array_emisor($data) {
    ...
    $emisor['amazonas'] = (isset($data_emisor['amazonas'])) ? $data_emisor['amazonas'] : '';
    $emisor['certpse'] = (isset($data_emisor['certpse'])) ? $data_emisor['certpse'] : 0;
    return $emisor;
}
