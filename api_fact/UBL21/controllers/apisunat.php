...
class Apisunat {
    ...
    public function enviar_documento($ruc, $usuario_sol, $pass_sol, $certpse, $ruta_archivo, $ruta_archivo_cdr, $archivo, $ruta_ws) {
        //=================ZIPEAR ================
        $zip = new ZipArchive();
    ...
    public function enviar_documento_baja($ruc, $usuario_sol, $pass_sol, $certpse, $ruta_archivo, $ruta_archivo_cdr, $archivo, $ruta_ws) {
        //=================ZIPEAR ================
        $zip = new ZipArchive();
        $filenameXMLCPE = $ruta_archivo . '.ZIP';
    ...
    public function enviar_resumen_boleta($ruc, $usuario_sol, $pass_sol, $certpse, $ruta_archivo, $ruta_archivo_cdr, $archivo, $ruta_ws) {
        //=================ZIPEAR ================
        $zip = new ZipArchive();
        $filenameXMLCPE = $ruta_archivo . '.ZIP';
