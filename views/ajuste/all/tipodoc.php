            ...
            <div class="modal-body">
                <div class="row floating-labels m-t-40">
                    ...
                    <div class="col-sm-12 m-t-0">
                        <input type="hidden" name="hidden_defecto" id="hidden_defecto" value="0">
                        <input type="checkbox" name="defecto" id="defecto" class="chk-col-green">
                        <label for="defecto">Por defecto <i class="ti-info-alt text-warning font-10" data-original-title="¿Seleccionar nota de venta por defecto?" data-toggle="tooltip" data-placement="top"></i></label>
                    </div>
                </div>
            </div>
