...
<div class="row">
                ...
                <div class="row floating-labels m-t-5">
                    <div class="col-sm-5 offset-sm-7">
                        <div class="form-group m-b-10">
                            ...
                            <span class="bar"></span>
                            <label for="global_filter_01">Búsqueda</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-lg-8">
        ...
        <div class="card text-center " id="ordenar-m" style="display: none; height: 100%; width: 100%">        
            <div class="card-body" style="height: 98%; width: 97%; ">
                <div id="contenedor_mesas" style="height: 95%; width: 97%; border: 1px solid #79df9d "></div>
...
<style type="text/css">
  ...
  background-color: #fff
    ...
    <script src="http://localhost/restobar/facturacion/public/plugins/jquery/jquery.min.js"></script>
    <link rel="stylesheet" type="text/css" href="http://localhost/restobar/facturacion/public/plugins/jquery-ui-1.12.1/jquery-ui.css">
    <script src="http://localhost/restobar/facturacion/public/plugins/jquery-ui-1.12.1/jquery-ui.js"></script>
