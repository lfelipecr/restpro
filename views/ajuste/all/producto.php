...
<input type="hidden" id="moneda" value="<?=Session::get('moneda')?>"/>
<input type="hidden" id="multiples_precios" value="<?=Session::get('multiples_precios')?>"/>
        ...
        <div class="card">         
            <div class="card-body">
                <div class="message-box contact-box">
                    ...
                    <ul class=" nav nav-tabs tabs-vertical2 hidden-xs-down"  id="ul-cat" style="font-size: 13px; width: 100%!important;overflow-x: hidden;overflow-y: auto; height: 620px">
                    ...
                    <div class="card-body p-t-0 p-b-0 floating-labels">
                        <div class="row" style="margin-left: -20px; margin-right: -20px">
                            ...
                            <div class="col-lg-7 p-0">
                                ...
                                <div class="table-responsive b-t m-b-10" style="font-size: 13px; width: 100%!important;overflow-x: hidden;overflow-y: auto; height: 450px">
                                    <table class="table table-condensed table-hover stylish-table" width="100%" id="table-productos">
                                        <thead class="table-head">
                                            ...
                                            <th style="width: 10%; text-align: right">Área</th>
                                ...
                                <div id="sinPres">
                                    <div class="row text-center">
                                        <div class="col-sm-10 offset-sm-1">
                                            <h4><i class="ti ti-arrow-circle-left"></i><br>Agregue o seleccione un producto</h4>
                                            <h6>Debes agregar o seleccionar un producto para poder agregar o modificar sus presentaciones</h6>
                                        </div>
                                    </div>
                                </div>
                                <div id="conPres" style="display: none">
                                    <div id="head-p"></div>
                                    <div id="body-c"></div>
                                    <div class="col-lg-12 m-t-20" id="filter_global">
                                        <div class="form-group m-b-0">
                                            <input class="form-control global_filterPres" id="global_filterPres" type="text" placeholder="Buscar presentacion">
                                            <span class="bar"></span>
                                        </div>
                                    </div>
                                    <div class="table-responsive b-t m-b-10 mt-2" style="font-size: 13px; width: 100%!important;overflow-x: hidden;overflow-y: auto; height: 400px">
                                        <table class="table table-condensed table-hover stylish-table" width="100%" id="table-presentaciones">
                                            <thead class="table-head">
                                                <th style="width: 70%; background-color: #E8FEF0!important;">Nombre - Código</th>
                                                <th style="width: 10%; background-color: #E8FEF0!important; text-align: center">Favorito</th>
                                                <th style="width: 15%; background-color: #E8FEF0!important; text-align: right">Precio</th>
                                                <th style="width: 10%; background-color: #E8FEF0!important;"></th>
                                            </thead>
...
<div class="modal inmodal" id="modal-presentacion" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="true">
    <div class="modal-dialog modal-lg">
        ...
        <input type="hidden" name="id_pres_presentacion" id="id_pres_presentacion">
            ...
            <ul class="nav nav-tabs jusdtify-content-end customtab" role="tablist">
                <li class="nav-item">
                            ...
                            <div class="col-sm-5 b-r">
                                ...
                                <div class="row floating-labels">
                                    <div class="col-sm-12 m-t-10 m-b-10 text-center text-danger">
                                        ...
                                        <input type="checkbox" name="favorito" id="favorito" class="chk-col-red text-danger"/>
                                        <label for="favorito" class="text-danger font-bold"><i class="fa fa-heart"></i> Favorito</label>
                                    </div>
                                    ...
                                    <div class="col-sm-6 m-t-10 m-t-0">
                                        <input type="checkbox" name="impuesto_icbper" id="impuesto_icbper" class="chk-col-green"/>
                                        <label for="impuesto_icbper">Impuesto a la bolsa plástica <i class="ti-info-alt text-warning font-10" data-original-title="Se activará el impuesto a la bolsa plástica ICBPER" data-toggle="tooltip" data-placement="top"></i></label>
                                    </div>
                                ...
                                <div class="row floating-labels">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group m-b-40">
                                            ...
                                            <span class="bar"></span>
                                            <label for="descripcion_presentacion">Descripción de la presentación <i class="ti-info-alt text-warning font-10" data-original-title="Escribe una descripción breve de la presentación" data-toggle="tooltip" data-placement="top"></i></label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group f m-b-40 dec">
                                            ...
                                            <span class="bar"></span>
                                            <label for="precio_presentacion">Precio venta 1 - <?php echo Session::get('moneda'); ?></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6" id="tp-4" style="display: none">
                                        <div class="form-group m-b-40 ent">
                                            ...
                                            <span class="bar"></span>
                                            <label for="stock_min_presentacion">Stock mínimo <i class="ti-info-alt text-warning font-10" data-original-title="Considere este valor para el control de stock" data-toggle="tooltip" data-placement="top"></i></label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6" id="tp-4-1" style="display: none">
                                        <div class="form-group m-b-40 ent">
                                            ...
                                            <label for="stock_limit">limitar venta <i class="ti-info-alt text-warning font-10" data-original-title="¿Deseas limitar venta acorde al stock en tus ventas?" data-toggle="tooltip" data-placement="top"></i></label>
                                        </div>
                                    </div> 
                            ...
                            <div class="col-sm-5 b-r">
                                <div class="row floating-labels">
                                    <div class="col-sm-6 m-t-10 m-b-10" id="">
                                        ...
                                        <input type="hidden" name="igv_impuesto" id="igv_impuesto" value="<?php echo Session::get('igv'); ?>"/>
                                        <input type="checkbox" name="impuesto_presentacion_compra" id="impuesto_presentacion_compra" class="chk-col-green"/>
                                        <label for="impuesto_presentacion_compra">Impuesto <?php echo Session::get('impAcr'); ?> <br> compra </label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-7">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-5">
                                        <input class="form-control input-lg input-mayu" type="text" id="nombre" placeholder="Nombre">
                                    </div>
                                    <div class="col-5">
                                        <input class="form-control s" type="number" id="precio" placeholder="Precio">
                                    </div>
                                    <div class="col-2">
                                        <input type="button" class="add-row btn btn-outline-success btn-sm" value="Agregar precio">
                                    </div>      
                                </div>
                                <table class="full-width table table-strisped mt-2 tb_precios">
                                    <thead class="table-info">
                                        <tr>
                                            <td width="45%" class="font-bold text-center">Nombre</td>
                                            <td width="45%" class="font-bold text-center">Precio</td>
                                            <td width="5%" class="font-bold text-center">Acciones</td>
                                        </tr>
                                    </thead>
                                    <tbody> </tbody>
                                </table>
                                <div id="procesoGuardarPrecio" style="display: none"></div>
                                <button type="button" class="btn btn-outline-success" id="guardar"> Guardar precios</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <form id="form-receta" method="post" class="form-receta">
                    ...
                    <h2 class="add-ct-btn text-right">
                        <div class="ml-auto">
                            ...
                            <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-download"></i> Descargar receta
                            </button>
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <!-- <a class="#" onclick="exportTableToExcel('TablaReceta')" id="btnExcel" receta="">Formato Excel</a> -->
            ...
            <div class="modal-body modal-lg p-0">
                <div class="table-responsive scroll_rseceta" style="overflow-y:scroll; height:400px;">
                    <table id="TablaReceta" class="table stylish-table m-l-0 m-r-0" width="100%">
                        <thead class="table-head">
                            <tr>
                                ...
                                <th class="text-center">Unidad <br> Medida</th>
                                <th class="text-center">Costo <br> Unitario</th>
                                <th class="text-center">Costo <br> total</th>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th colspan="2" id="total_items" class="text-left">0</th>
                                <th colspan="2" class="text-right">Total Costo receta</th>
                                <th id="total_receta">0.00</th>
                                <th colspan="2"></th>
                            </tr>
                        </tfoot>
                    </table>   
