...
<input type="hidden" id="sep_items" value="<?php echo Session::get('sep_items'); ?>"/>
...
<input type="hidden" id="mostrarimagen" value="<?php echo Session::get('mostrarimagen'); ?>"/>
...
<input type="hidden" id="nota_ind" value="<?php echo Session::get('nota_ind'); ?>"/>
...
<input type="hidden" id="precio_comanda" value="<?=Session::get('precio_comanda')?>"/>
            ...
            <div class="card-body p-0">
                <div class="row" style="margin-left: 0; margin-right: 0;">
                    <?php if(Session::get('rol') <> 5) { ?>
                        <div class="col-5 btn-dividir-pos opc1" style="display: none" onclick="conf_dividir(<?php echo Session::get('codped'); ?>,2);">
        ...
        <input type="hidden" name="total_venta" id="total_venta">
            ...
            <div class="modal-body p-t-0 p-b-0" >
                <div class="container-fluid p-l-0 p-r-0" style="background: #fbfdff;">
                    <div class="row p-l-0" style="padding: 0px ; margin: 0px">
                        <!-- Column -->
                        <div class="col-md-5 p-l-0 p-r-0 b-l b-r" style="height: 60%;background: #fff;">
                            ...
                            <div class="scroll_list_items_facturar lista-producto-facturar">
                            ...
                            <table class="table table-condensed m-t-0 m-b-0" style="background: #fcf8ec; border-bottom-left-radius: .3rem;">
                                <thead>
                                    ...
                                    <tr class="text-muted font-13 display-icbper">
                                        <th class="p-b-5">Impuesto a la bolsa - ICBPER</th>
                                        <th class="text-right p-b-5">
                                            <input type="text" name="monto_icbper" id="monto_icbper" class="icbper" value="0.00">
                                            <?php echo Session::get('moneda'); ?> <span class="icbper">0.00</span>
                                        </th>
                                    </tr>
                        ...
                        <!-- Column -->
                        <div class="col-md-7" style="background: #fbfdff; padding: 0px; margin: 0px">
                            <table class="table table-hover s0">
                                <thead class="text-white" style="background: #ffc478;">
                                    <tr>
                                        <th width="50%" class="text-right" style="vertical-align: middle; height: 10px; padding: 4px">TIPO DE DOCUMENTO:</th>
                                        <th style="height: 10px; padding: 4px">
                            ...
                            <div class="col-lg-12 p-t-10 p-b-10">
                                ...
                                <label class="font-13 text-inverse display-pago-default">INGRESE MONTO <span class="ml-5 danger_alert" id="mensaje_total">Complete el pago.</span></label>
                                <div class="input-group">
                                    <!-- efectivo -->
                                    ...
                                    <input type="text" class="form-control form-control-lg display-pago-efectivo doble_clic" style="width: 95px;height: 58px; border-left: 0px; border-right: 0px;" name="pago_efe" id="pago_efe" autocomplete="off" onclick="limpiar_pago('pago_efe')">
                                    ...
                                    <input type="text" class="form-control form-control-lg display-pago-tarjeta doble_clic" style="width: 95px;height: 58px;border-left: 0px; border-right: 0px;" name="pago_tar" id="pago_tar" value="0.00" autocomplete="off" onclick="limpiar_pago('pago_tar')"/>
                                    
                                    <div class="input-group-prepend display-pago-tarjeta">
                                        <span class="input-group-text bg-white" style="display: grid; width: 45px;">
                                            <small class="text-left">YAPE</small>
                                            <div class="text-left font-medium"><?php echo Session::get('moneda'); ?></div>
                                        </span>
                                    </div>
                                    <input type="text" class="form-control form-control-lg display-pago-tarjeta doble_clic" style="width: 95px;height: 58px;border-left: 0px; border-right: 0px;" name="pago_yape" id="pago_yape" value="0.00" autocomplete="off" onclick="limpiar_pago('pago_yape')"/>

                                    <div class="input-group-prepend display-pago-tarjeta">
                                        <span class="input-group-text bg-white" style="display: grid; width: 45px;">
                                            <small class="text-left">PLIN</small>
                                            <div class="text-left font-medium"><?php echo Session::get('moneda'); ?></div>
                                        </span>
                                    </div>
                                    <input type="text" class="form-control form-control-lg display-pago-tarjeta doble_clic" style="width: 95px;height: 58px;border-left: 0px; border-right: 0px;" name="pago_plin" id="pago_plin" value="0.00" autocomplete="off" onclick="limpiar_pago('pago_plin')"/>


                                    <div class="input-group-prepend display-pago-tarjeta">
                                        <span class="input-group-text bg-white" style="display: grid; width: 45px;">
                                            <small class="text-left">TRANS</small>
                                            <div class="text-left font-medium"><?php echo Session::get('moneda'); ?></div>
                                        </span>
                                    </div>
                                    <input type="text" class="form-control form-control-lg display-pago-tarjeta doble_clic" style="width: 95px;height: 58px;border-left: 0px; border-right: 0px;" name="pago_tran" id="pago_tran" value="0.00" autocomplete="off" onclick="limpiar_pago('pago_tran')"/>
                            ...
                            <hr class ="my-2">
                                <div class="col-lg-12  row">
                                    <div class="col-lg-6" style="padding-top: 10px">
                                        <div class="switch">
                                            <span class="mr-2 display_venta_por_consumo">  
                                                <input type="checkbox" name="venta_por_consumo" id="venta_por_consumo" class="lever switch-col-light-green venta_por_consumo"/>
                                                <label for="venta_por_consumo" class="m-0" style="color: black">VENTA POR CONSUMO</label>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <textarea class="form form-control" cols="1" rows="1" id="observacion" placeholder="Observaciones"></textarea>
                                    </div>
                                </div>
                            <hr class ="my-2">
                        </div>
                    ...
                    <div class="col-lg-6 b-r">
                        <div class="row card-body p-0">
                            <div class="col-md-12 p-l-10 p-t-10 b-t b-b m-b-40 bg-light-info" style="display: flex;">
                                <h6 class="font-medium">Información personal</h6>
                            </div>                       
    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInTop">
            ...
            <div class="modal-body floating-labels">
                ...
                <div class="nota_manual mt-3"></div>
...
<script>
    var tdoc_defecto = <?php echo $tdoc_defecto; ?>;
</script>
<script id="nvo-ped-det-template" type="text/x-jsrender" src="">
    ...
    <tr class="warning-element" style="border-left: 2px solid #ffb22b !important; background: #fefde3;">
        <td style="padding: 5px 14px;">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12 col-xl-12 text-right" style="font-size:14px;  ">
                    <span name="producto">{{:producto}}</span><br><span name="presentacion" style="font-size:12px; " class="label label-warning text-uppercase">{{:presentacion}}</span>
                </div>
            </div>
            <div class="row mt-1">
                <div class="col-6 col-md-12 col-lg-6 col-xl-6">
                        ...
                        <input type="hidden" name="nombreprecio" value="{{:nombreprecio}}">
                        <div class="input-group  bootstrap-touchspin bootstrap-touchspin-injected"><input class="touchspin1 input-sm input text-left form-control" type="text" value="{{:cantidad}}" name="cantidad" onchange="pedido.actualizar({{:id}}, this);">
                    </div>
                </div>
                <div class="col-6 col-md-12 col-lg-6 col-xl-6">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><?php echo Session::get('moneda'); ?>  </span>
                        </div>
                        <input type="text" name="precio" value="{{:precio}}" onchange="pedido.actualizar({{:id}}, this);" class="form-control preciolist_{{:id}}" disabled="" onfocus="this.select()">
                    </div>
                </div> 
            </div>
            <div class="row mt-2">
                <div class="col-12 col-md-12 col-lg-12 col-xl-12 text-left">
                    <code style="font-size: 15px; font-weight: bold" class="txtnota{{:id}}">{{:comentario}}</code>
                </div>
                <div class="col-12 col-md-12 col-lg-12 col-xl-12 text-left">
                    <?php
                    if (Session::get('editarprecio')==1) { ?>
                        <button type="button" class="btn ml-2 waves-effect waves-light btn-outline-info" onclick="preciolist({{:id}});"><i class="fas fa-edit"></i></button>
                    <?php } ?>

                    <button type="button" class="btn ml-2 waves-effect waves-light btn-outline-info" onclick="comentar({{:id}},{{:producto_id}},'{{:producto}}','{{:presentacion}}');"><i class="fas fa-comment-alt"></i></button>
                    <button type="button" class="btn ml-2 waves-effect waves-light btn-outline-danger" onclick="pedido.retirar({{:id}});"><i class="fas fa-trash"></i></button>
...
<script type="text/javascript">
    <?php if ($_GET["cobra_directo"] == "si") {?>
        setTimeout(function(){
          facturar(<?php echo Session::get('codped'); ?>,1);
        }, 1000);
    <?php } ?>
</script>