    ...
    <div class="col-lg-8 u4 u4-2-1">
        <div class="card m-b-5">
            ...
            <ul class="nav nav-tabs customtab" role="tablist">
                ...
                <a class="nav-link nav-item" style="padding-top: 15px" href="http://<?=Session::get('pc_ip')?>/imprimir/gaveta.php" target="_blank"><span class="hidden-sm-up">Delivery</span><span class="hidden-xs-down"><i class="fas fa-money-bill-alt"> </i> GAVETA</span></a>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content">
                ...
                <div class="tab-pane p-0 active" id="tabp-1" role="tabpanel">
                    <ul class="nav nav-tabs tabs-horizontal hidden-sm-up" role="tablist">
                        <?php $cont=1;$cont_salon = 0; foreach($this->Salon as $key => $value): ?>
                            <li class="nav-item list-salones m-t-10">
                                <a class="nav-link zonas" data-toggle="tab" href="#tab-<?php echo $value['id_salon']; ?>" role="tab" id="tab<?php echo $cont++; ?>" onclick="mesa_list(<?php echo $value['id_salon']; ?>)">
                                    <!-- <span class="hidden-sm-up"><?php $cont_salon = $cont_salon + 1;echo 'SA'.$cont_salon; ?></span> -->
                            ...
                            <?php $cont=1;$cont_salon = 0; foreach($this->Salon as $key => $value): ?>
                                <li class="nav-item list-salones m-t-10">
                                    <a class="nav-link" data-toggle="tab" href="#tab-<?php echo $value['id_salon']; ?>" role="tab" id="tab<?php echo $cont++; ?>" onclick="mesa_list(<?php echo $value['id_salon']; ?>)">
                                        <!-- <span class="hidden-sm-up"><?php $cont_salon = $cont_salon + 1;echo 'SA'.$cont_salon; ?></span> -->
                                        <span class="hidden-xs-down font-14"><?php echo $value['descripcion']; ?></span>
                                    </a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    ...
                    <div class="cont02 m-t-20" style="display: none;">
                        <div class="row p-t-0 p-l-20 p-r-20 p-b-10">
                            ...
                            <div class="col-md-12 display-nombre floating-labels" style="display: none;">
                                <div class="form-group letMayMin m-t-20 m-b-40">
                            ...
                            <div class="col-12 col-md-4 display-nombre floating-labels" style="display: none;">
                                <div class="form-group letMayMin m-t-20 m-b-40">
                                    <select class="selectpicker form-control bg-t" name="id_tdoc" id="id_tdoc" data-style="form-control btn-default" title="Seleccionar" data-live-search-style="begins" data-live-search="true">
                                        <option value="1" selected="">DNI</option>
                                        <option value="2">RUC</option>
                                    </select>
                                    <span class="bar"></span>
                                    <label for="nomb_cliente"> Tipo Documento</label>
                                </div>
                            </div>
                            <div class="col-12 col-md-8 display-nombre floating-labels" style="display: none;">
                                <div class="form-group tdocInput m-t-20 m-b-40">
                                    <input type="text" class="form-control bg-t" name="num_cliente" id="num_cliente" autocomplete="off"/>
                                    <span class="bar"></span>
                            ...
                            <div class="col-sm-12 display-repartidor floating-labels" style="display: none;">
                                <div class="form-group m-t-40 m-b-0">
                                    <select class="selectpicker form-control bg-t" name="id_repartidor" id="id_repartidor" data-style="form-control btn-default" title="Seleccionar" data-live-search-style="begins" data-live-search="true" required>
                                        ...
                                        <optgroup>
                                            <option value="2222">DIDI FOOD</option>
                                            <!-- <option value="3333">UBER</option> -->
                                            <option value="4444">PEDIDOS YA</option>
                                        </optgroup>
                                        <?php } ?>
                                    </select>
                                    <span class="bar"></span>
                            ...
                            <div class="col-sm-12 display-mozo floating-labels" style="display: none;">
                                <div class="form-group m-b-40">
                                    <select class="selectpicker form-control bg-t" name="id_mozo" id="id_mozo" data-style="form-control btn-default" title="Seleccionar" data-live-search-style="begins" data-live-search="true">
                ...
                <div class="row">
                    ...
                    <div class="col-7 text-right p-l-0">
                        ...
                        <div class="btn-group display-opciones-pedido" style="display: none;">
                            ...
                            <div class="dropdown-menu">
                                <a href="javascript:void(0);" class="dropdown-item opc-ticket-pedido"><i class="fa fa-list"></i> Ticket reparto</a>
            ...
            <div class="modal-body">
                <div class="row floating-labels m-t-40">
                    ...
                    <div class="col-md-12 display-paga-con floating-labels" style="display: block">
                        <div class="form-group m-b-40">
                            <input type="text" class="form-control input-mayus" name="total_pagar" id="total_pagar" autocomplete="off"/>
                            <input type="hidden" class="form-control input-mayus" name="total_pagar_" id="total_pagar_" autocomplete="off"/>
                            <span class="bar"></span>
                            <label for="paga_con">Total a pagar</label>
                        </div>
                    </div>
                    <div class="col-md-12 display-paga-con floating-labels" style="display: block">
                        <div class="form-group m-b-40">
...
var id_mozo_ = $("#id_mozo option:first-child").val()
var id_repartidor_ = $("#id_repartidor option:first-child").val()
