...
<div id="wrapper-2">
    <div class="row auth-wrapper gx-0">
        <div class="col-lg-7 col-xl-8 bg-primary auth-box-2 on-sidebar hidden-md-down" style="background-image:url(<?php echo URL; ?>public/images/background/fondo-logininsa.jpg); background-size: cover;">
                ...
                <div class="col-12">
                    <div class="">
                        ...
                        <form class="form-horizontal floating-labels" id="frm-login" role="form" method="post">
                            <h5 class="box-title m-b-20">Ingrese código</h5>
                            ...
                            <button class="btn btn-warning btn-block btn-lg text-uppercase waves-effect waves-light" type="submit">ACCEDER</button>
                        </form>
                        <div class="mt-4 mb-3 px-5" >
                            <a class="btn btn-primary btn-lg btn-block" href="<?php echo URL; ?>">Retroceder</a>
                        </div>
                        <div class="text-center" style="font-size: 12px;">FacTUYO.com | Todos los derechos reservados</div>
