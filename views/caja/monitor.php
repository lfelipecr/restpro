        ...
        <div class="card">
            <div class="card-body p-0 display-two" style="display: block;">
                <ul class="nav nav-tabs customtab" role="tablist">
                    <li class="nav-item"> <a class="nav-link list-mesas " data-toggle="tab" href="#tab1" role="tab"><span class="hidden-sm-up">Mesas por cobrar</span> <span class="hidden-xs-down">Mesas por cobrar</span></a> </li>
                    <li class="nav-item"> <a class="nav-link list-ventas active" data-toggle="tab" href="#tab2" role="tab"><span class="hidden-sm-up">Lista de ventas</span> <span class="hidden-xs-down">Lista de ventas</span></a> </li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <div class="tab-pane p-0" id="tab1" role="tabpanel">
                    ...
                    <div class="tab-pane p-0 active" id="tab2" role="tabpanel">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group m-b-40">
                                            <div class="input-group">
                                                <input type="text" class="form-control font-14 text-center" name="start" id="start" value="<?php echo ''.$fechaa.' AM'; ?>" autocomplete="off"/>
                                ...
                                <div class="text-center m-b-20">
                                    <div class="row">
                                        ...
                                        <div class="col-4" style="float: left">
                                            <h2 class="font-medium text-warning m-b-0 font-30 ventas-total-anulados"></h2>
                                            <h6 class="font-bold m-b-10">Total anulados</h6>
                                        </div>
                                        <div class="col-4">
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        ...
        <form id="form-editar-documento" class="form-editar-documento" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-12">
                    <label class="label-control font-13">Fecha para emisión </label>
                    ...
                    <input type="text" name="fecha_nueva" id="fecha_nueva" value="" min="<?=$date_past?>" class="form-control font-14 text-center" />
                    <label class="label-control font-13 mt-4">Buscar cliente</label>
                    <div class="input-group">
