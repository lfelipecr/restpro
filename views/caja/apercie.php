                ...
                <div class="col-lg-6 p-0">
                    <div class="p-0">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group m-b-20 dec">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="onlyNum" class="form-control form-control-lg" style="height: 58px;border-left: 0px; border-right: 0px;" name="monto_aper" id="monto_aper" value="0" autocomplete="off" required>
                        ...
                        <form id="form-cierre" method="post" class="display-cierre" style="display: none;" enctype="multipart/form-data">
                            ...
                            <input type="hidden" style="font-weight: bold;" name="monto_sistema" id="monto_sistema">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group m-t-20 m-b-20 dec">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="onlyNum" class="form-control form-control-lg" style="height: 58px;border-left: 0px; border-right: 0px;" name="monto_cierre" id="monto_cierre" value="0" autocomplete="off" required>
                                                <div class="input-group-append">
                                                    <span class="input-group-text bg-white text-muted"><?php echo Session::get('monAcr'); ?></span>
                                                </div>
                                            </div>                           
