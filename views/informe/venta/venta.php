                        ...
                        <div class="col-lg-4">
                            <div class="form-group m-b-40">
                                <div class="input-group">
                                    <input type="text" class="form-control font-14 text-center" name="start" id="start" value="<?php echo ''.$fechaa; ?>" autocomplete="off"/>
            ...
            <div class="text-center m-b-20">
                <div class="row">
                    ...
                    <div class="col-2">
                        ...
                        <h6 class="font-bold m-b-10">Total Ventas</h6>
                    </div>
                    <div class="col-2">
                        <h2 class="font-medium text-warning m-b-0 font-30 ventas-nv"></h2>
                        <h6 class="font-bold m-b-10">Total Notas de Venta</h6>
                    </div>
                    <div class="col-2">
                        <h2 class="font-medium text-warning m-b-0 font-30 ventas-bv"></h2>
                        <h6 class="font-bold m-b-10">Total Boletas</h6>
                    </div>
                    <div class="col-2">
                        <h2 class="font-medium text-warning m-b-0 font-30 ventas-fe"></h2>
                        <h6 class="font-bold m-b-10">Total Facturas</h6>
                    </div>
                    <div class="col-2">
                        <h2 class="font-medium text-warning m-b-0 font-30 ventas-an"></h2>
