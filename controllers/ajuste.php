...
class Ajuste extends Controller {
	...
	{	
        ...
        $this->view->js = array('ajuste/js/aju_plataforma.js');
    ...
    function usuario(){
        ...
        $this->view->total_users = $this->model->limit('user');
    ...
    function producto_pres_precios_crud()
    {
        print_r(json_encode($this->model->producto_pres_precios_crud($_POST)));
    }
   ...
   function insumo_cat_crud()
    ...
    function optimizar_inventario()
    {
        print_r(json_encode($this->model->optimizar_inventario($_POST)));
    }

    function optimizar_database()
    {
       $this->model->optimizar_database($_POST);
    }
    ...
    function sistema(){
        ...
        $this->view->Iconos     = $this->model->iconosRapidos();
        $this->view->js         = array('ajuste/js/aju_opt_sis.js');
        $this->view->render('ajuste/all/sistema', false);
    }

    function iconosRapidos()
    {
        print_r(json_encode($this->model->iconosRapidos()));
    }

    function guardaricono()
    {
        print_r(json_encode($this->model->guardaricono($_POST)));
    }
    ...
    function contadorplan(){
        $this->model->contadorplan();
    }
    function datosplataforma_data()
    {
        print_r(json_encode($this->model->datoplataforma_data()));
    }
    function datosplataforma_crud()
    {
        print_r(json_encode($this->model->datoplataforma_crud($_POST)));
    }
}