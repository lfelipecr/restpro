...
class Caja extends Controller {
    ...
    function impresion_ingreso($id_pedido)
    {
        ...
        //     header('location: http://'.Session::get('pc_ip').'/imprimir/ingreso.php?data='.json_encode($dato));
        // } else {
    ...
    function impresion_egreso($id_pedido)
    {
        ...
        //     header('location: http://'.Session::get('pc_ip').'/imprimir/egreso.php?data='.json_encode($dato));
        // } else {
