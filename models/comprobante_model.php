...
class Comprobante_Model extends Model
{
    ...
    public function venta_all_imp_($data)
    {
        ...
        {      
            ...
            $c->{'Pedido'} = $this->db->query("SELECT vm.desc_salon, vm.nro_mesa  FROM tm_pedido_mesa AS pm INNER JOIN v_mesas AS vm ON pm.id_mesa = vm.id_mesa WHERE pm.id_pedido = " . $c->id_ped)->fetch(PDO::FETCH_OBJ);
